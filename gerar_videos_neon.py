...
TEMA_IMAGENS = {
    ...
    "Menopausa": "imagens_temas/menopausa.png",
}
...
def desenhar_painel_imagem_tema(img, tema):
    ...
    draw_centered_text(draw, "IMAGEM", y1 + 150, fonte(34, True), GRAY, x1, x2)
    draw_centered_text(draw, "DO TEMA", y1 + 198, fonte(29, True), GRAY, x1, x2)
...
def render_frame(tema, pergunta, numero, total_perguntas, estado, timer=None):
    ...
    if MODO_LAYOUT == 2:
        ...
        # No novo modo 2 a imagem aparece só na introdução do tema.
